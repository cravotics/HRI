...
class RosIntegration(Node):
    def __init__(self, namespace_list=["robot_1", "robot_2"]):
        ...
        self.nav_clients = []
        # New attributes to hold UI callback functions:
        self.odom_ui_callback = None
        self.image_ui_callback = None
    ...
    def odom_callback(self, msg):
        ...
        # If a UI callback is set, pass the odometry string for display.
        if self.odom_ui_callback:
            self.odom_ui_callback(text)
    ...
    def image_callback(self, msg):
        ...
        if pixmap:
            # If a UI callback is set, forward the pixmap.
            if self.image_ui_callback:
                self.image_ui_callback(pixmap)
