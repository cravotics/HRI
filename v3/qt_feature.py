from PyQt5.QtWidgets import (QWidget, QVBoxLayout, QLabel, QComboBox, QProgressBar,
                             ...
                             QInputDialog, QTextEdit, QSplitter, QMessageBox)
...
class RobotMonitorUI(QWidget):
    def __init__(self, ros_interface):
        ...
        # --- Set UI callbacks in the ROS integration node ---
        # These callbacks will be invoked whenever new odometry or image data arrives.
        self.ros_interface.odom_ui_callback = self.update_odom_ui
        self.ros_interface.image_ui_callback = self.update_image_view
    ...
    def update_odom_ui(self, text):
        # This method is called from the ROS integration node whenever new odometry data arrives.
        self.odom_value.setText(text)
    
    def update_image_view(self, pixmap):
        # This method is called from the ROS integration node whenever a new camera image is available.
