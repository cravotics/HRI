...
def generate_launch_description():
    ...
    robots = [
        {'name': 'waffle_1', 'x_pose': '-1.5', 'y_pose': '-0.5', 'z_pose': 0.01},
        {'name': 'waffle_2', 'x_pose': '-1.5', 'y_pose': '0.5', 'z_pose': 0.01},
        {'name': 'waffle_3', 'x_pose': '1.5', 'y_pose': '-0.5', 'z_pose': 0.01},
        {'name': 'waffle_4', 'x_pose': '1.5', 'y_pose': '0.5', 'z_pose': 0.01},
        ]
